...
<template>
  <div class="month-model">
    <div class="v-crontab-from-model">
      <el-radio-group v-model="radioMonth" vertical>
        <div class="list-box">
          <el-radio label="everyMonth">
            <span class="text">每一月</span>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="intervalMonth">
            ...
            <span class="text">月开始</span>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="specificlMonth">
            <span class="text">具体月数(可多选)</span>
            <el-select size="mini" multiple placeholder="请选择具体月数" v-model="specificMonthVal">
              <el-option
