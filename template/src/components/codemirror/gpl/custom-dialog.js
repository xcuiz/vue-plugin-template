...
function dialogDiv(cm, template, bottom, className) {
  var wrap = cm.getWrapperElement();
  var dialog;
  dialog = wrap.appendChild(document.createElement("div"));
  if (bottom)
    dialog.className =
      "CodeMirror-dialog CodeMirror-dialog-bottom " + className;
  else
    dialog.className = "CodeMirror-dialog CodeMirror-dialog-top " + className;
...
CodeMirror.defineExtension("openCustomDialog", function(
  template,
  callback,
  options
) {
  ...
  var dialog = dialogDiv(this, template, options.bottom, options.className);
  var closed = false,
    me = this;
...
CodeMirror.defineExtension("openCustomConfirm", function(
  template,
  callbacks,
  options
) {
 ...
 */
CodeMirror.defineExtension("openCustomNotification", function(
  template,
  options
) {
