<template>
  <div class="increased-field-container">
    <common-page
      :title="title"
...
export default {
  ...
  data() {
    return {
      ...
      probeFilterUrl: "/gov/api/common/page/filter/increasedField",
      filterOptionUrl: "/gov/api/common/filter/value/increasedField/{code}",

      aggFilterUrl: "/gov/api/common/agg/filter/increasedField",
