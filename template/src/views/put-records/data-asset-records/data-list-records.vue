<template>
  <div class="container">
    <div class="content">
      <PageHeader title="敏感数据资产备案"> </PageHeader>
      <div class="flex-sb-box">
        <FilterBar
          v-model="filterValue"
          :fields="filterFields"
          module-code="dataFiling"
        />
            ...
            >
              ...
              <template slot-scope="scope">
                <el-button
                  ...
                  custom
                  size="mini"
                  @click="goToDetail(scope.row.id, scope.row.assetId)"
                >
                  {{ scope.row.name }}
                </el-button>
              </template>
            ...
            <el-table-column fixed="right" label="操作" min-width="120">
              <template slot-scope="scope">
                <el-button
                  ...
                  custom
                  size="mini"
                  @click="recordCheck(scope.row.id)"
                  >备案</el-button
                >
                <el-button
                  type="text"
  ...
  methods: {
    ...
    async toExport() {
      ...
      if (
        ...
        param = { ...this.filterFormData.param };
      }
      this.loading = true;
      try {
