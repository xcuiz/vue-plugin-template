...
import formTable from "../../data-resource-manage/components/form-table-child";
...
export default {
  ...
  methods: {
    ...
    toNoClaim() {},
    /**
     * claimType： "1":已认领，"2":无主认领
     */
    handleSubmit(claimType) {
      if (claimType === "2") {
        // 无主认领时,不需要表单校验
        this.checkSuccess(claimType);
        return;
      }
