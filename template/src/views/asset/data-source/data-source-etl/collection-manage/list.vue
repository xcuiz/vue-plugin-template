    ...
    <div class="content">
        ...
        <template slot="left">
          <div class="filter-items">
            ...
            <el-button
              ...
              plain
              :disabled="!selectedIds.length"
              @click="handleMulitOperate('close')"
            >
              关闭
            </el-button>
            <el-button
              ...
              plain
              :disabled="!selectedIds.length"
              @click="handleMulitOperate('delete')"
            >
              删除
            </el-button>
          </div>
      ...
      <el-row style="position: relative">
        ...
        >
          ...
          <el-table-column label="描述" prop="etlDesc" />
          <el-table-column
            label="创建时间"
            prop="createTime"
            sortable="custom"
          ...
          <el-table-column label="操作" width="120">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                custom
                size="mini"
                @click="handleOperate(scope.row.id, 'open')"
                >开启</el-button
              >
              <el-button
                ...
                custom
                size="mini"
                @click="handleOperate(scope.row.id, 'close')"
                >关闭</el-button
              >
            </template>
          </el-table-column>
...
import { getPage, operateCollect } from "./api";
export default {
  components: {
    PageHeader,
    MyFilter,
  ...
  methods: {
    ...
    handleOperate(id, operateType) {
      this.operate([id], operateType);
    },
    handleMulitOperate(operateType) {
      this.operate(this.selectedIds, operateType);
    },
    operate(idList, operateType) {
      const operates = {
        open: "开启",
        close: "关闭",
        delete: "删除",
