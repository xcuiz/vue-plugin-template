<!--
 * @Author: your name
 * @Date: 2021-09-18 15:02:31
 * @LastEditTime: 2021-11-18 15:17:27
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \data-gov-web\src\views\asset\data-source-detect\source-detect-task\components\ScanDetail.vue
-->
    ...
    async loadDetail() {
      ...
      try {
        const result = await this.$request({
          url: `/gov/api/data/job/getDaqTaskInfosByTaskId/${this.taskId}`,
          method: "GET",
        });
