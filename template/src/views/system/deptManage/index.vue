        ...
        <div class="name-list-content">
          ...
          <div v-loading="tableLoading" class="name-list-table">
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  {{ scope.row.deptLevel | deptLevelFormatter }}
                </template>
              </el-table-column>
              <el-table-column
                label="父级部门"
...
export default {
  ...
  data() {
    return {
      ...
      // 获取列表数据的url
      listUrl: "/gov/api/asset/dept/page",
      // 模块名
  ...
  methods: {
    ...
    async toDownload() {
      ...
      try {
        const result = await this.$request(
          {
            url: "/gov/api/common/downloadTemp/dept",
            method: "GET",
          },
          {
            responseType: "blob",
