<template>
  <div class="dictionary-manage-container">
    <div class="dictionary-manage-box">
      <div class="header-box">
        <div class="header-title">字典管理</div>
        <PageHeader title="">
            ...
            >
              <template slot="left">
                <div class="filter-items">
                  ...
                  <!-- <div class="filter-items-btn">
                    <el-button size="mini" type="primary" @click="toLeadIn">
                      导入
                    </el-button>
                  </div> -->
                  <div class="filter-items-btn">
        ...
        <div class="name-list-content">
          ...
          <div v-loading="tableLoading" class="name-list-table">
            ...
            >
              ...
              <el-table-column label="主键名" show-overflow-tooltip prop="code">
                <template slot-scope="scope">
                  {{ scope.row.code || "-" }}
                </template>
              </el-table-column>
              ...
              <el-table-column label="顺序" show-overflow-tooltip prop="sortNo">
                <template slot-scope="scope">
                  {{ scope.row.sortNo || "-" }}
                </template>
              </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      // 获取筛选条件的url
      probeFilterUrl: "/gov/api/common/page/filter/dictionary",
      // 获取筛选条件option的url
      filterOptionUrl: "/gov/api/common/filter/value/dictionary/{code}",
      // 聚合下拉框获取数据url
      aggFilterUrl: "/gov/api/common/agg/filter/dictionary",
      // 获取聚合数的url
      aggCountUrl: "/gov/api/data/dictionary/agg",
      // 获取列表数据的url
      listUrl: "/gov/api/dictionary/page",
      // 模块名
