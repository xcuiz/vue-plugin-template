<template>
  <div class="pool-manage-container">
    <div class="pool-manage-box">
      <div class="header-box">
        <div class="header-title">资源池管理</div>
        <PageHeader title="">
...
export default {
  ...
  data() {
    return {
      ...
      // 获取列表数据的url
      listUrl: "/gov/api/asset/pool/page",
      // 模块名
  ...
  methods: {
    ...
    async toDownload() {
      ...
      try {
        const result = await this.$request(
          {
            url: "/gov/api/common/downloadTemp/resourcePool",
            method: "GET",
          },
          {
            responseType: "blob",
