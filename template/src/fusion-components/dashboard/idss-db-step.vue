        ...
        <div
          ...
          <span
            ...
            <span
              ...
              <span
                class="li_semicircle"
                :style="{'border': `${mediumLineWidth}px solid ${config.mediumLineStyle.color}`}">
              </span>
              <span
...
export default {
  ...
  methods: {
    ...
    */
     ...
     */
    linkLine () {
      let curBoxAttr = this.direction === 'horizontal' ? { 'height': `${this.mediumLineWidth}px`, 'marginLeft': `${-this.mediumLineWidth}px`, 'marginRight': `${-this.mediumLineWidth}px` } : { 'width': `${this.mediumLineWidth}px`, 'marginTop': `${-this.mediumLineWidth}px`, 'marginBottom': `${-this.mediumLineWidth}px` }
